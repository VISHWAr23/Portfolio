...
const Contact = () => {
  ...
  const quickMessages = [
    "Hi Vishwa! I'd like to discuss a potential collaboration opportunity.",
    "Hello! I'm interested in your backend development expertise.",
    "Hi there! I came across your portfolio and would love to connect.",
    "Greetings! I have a project that might be perfect for your skills."
  ];
      ...
      >
        ...
        >
          <div className="relative inline-block">
            <motion.div
              className="absolute -inset-4 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-lg blur-xl"
              animate={{ 
                scale: [1, 1.05, 1],
                opacity: [0.5, 0.8, 0.5]
              }}
        ...
        <AnimatePresence>
          {showAvailability && (
            ...
            >
              <motion.div 
                className="flex items-center gap-3 bg-green-500/10 border border-green-500/30 rounded-full px-6 py-3"
                ...
                >
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="p-2 rounded-lg bg-gray-800/50 hover:bg-cyan-500/20 text-gray-400 hover:text-cyan-400 transition-all duration-300 opacity-0 group-hover:opacity-100"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <motion.span 
                        className={`text-xs ${messageCount > maxMessageLength * 0.8 ? 'text-yellow-400' : 'text-gray-500'}`}
                        animate={{ 
                          color: messageCount > maxMessageLength * 0.9 ? '#ef4444' : 
                                 messageCount > maxMessageLength * 0.8 ? '#eab308' : '#6b7280'
                        }}
                      >
